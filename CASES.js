...
const ALL_DIAGNOSES = [
  "Dengue","Leptospirose","Doença de Chagas","Tuberculose Pulmonar","Infarto Agudo do Miocárdio com Supra de ST",
  "Acidente Vascular Cerebral Isquêmico","Meningite Bacteriana","Apendicite Aguda","Cetoacidose Diabética",
  "Pré-eclâmpsia","Pneumonia Comunitária","Insuficiência Cardíaca Descompensada","Tromboembolia Pulmonar",
  "Malária por Plasmodium falciparum","Leishmaniose Visceral","Hipotireoidismo Primário","Chikungunya",
  "Cirrose Hepática","Pancreatite Aguda","HIV / AIDS","Febre Tifoide","Acidente Vascular Cerebral Hemorrágico",
  "Síndrome de Burnout","Síndrome Coronariana Aguda sem Supra de ST","Hipertensão Arterial Sistêmica",
  "Angina Estável","Miocardite","Pericardite","Dissecção Aórtica","Hemorragia Subaracnóidea",
  "Epilepsia","Esclerose Múltipla","Pneumotórax","Derrame Pleural","DPOC Agudizado","Asma Aguda",
  "Hepatite A","Hepatite B","Hepatite C","Colangite","Úlcera Péptica","Doença de Crohn",
  "Retocolite Ulcerativa","Insuficiência Renal Aguda","Pielonefrite","Cólica Renal","Eclâmpsia",
  "Gravidez Ectópica","Sepse","Choque Séptico","Hipoglicemia","Estado Hiperglicêmico Hiperosmolar",
  "Paracoccidioidomicose","Histoplasmose","Febre Amarela","Zika","Anemia Falciforme",
  "Leucemia","Lúpus Eritematoso Sistêmico","Artrite Reumatoide","Fibromialgia","Depressão",
  "Transtorno Bipolar","Esquizofrenia","Câncer de Pulmão","Câncer Gástrico","Melanoma",
  "Tétano","Raiva","Hantavirose","Síndrome Nefrótica","Glomerulonefrite","Oclusão Intestinal",
  "Síndrome de Cushing","Insuficiência Adrenal","Feocromocitoma","Hipercalcemia","Hiponatremia",
  "Rabdomiólise","Endocardite Infecciosa","Miocardiopatia Hipertrófica","Estenose Aórtica",
  "Mononucleose Infecciosa","Toxoplasmose","Candidemia","Leishmaniose Tegumentar"
];
